...
data_config = {
    "mode": "pretrain",
    "data": {
        # "mixed": "/nvme/Open-Llama/data/pretrain_data/part-*.jsonl.zst",
        "wudao": "/nvme/Open-Llama/data/pretrain_data/part-wudao*.jsonl.zst",
        # 由于加载了Llama模型的ckpt所以只使用少量英文数据
        "the_pile": "/nvme/Open-Llama/data/pretrain_data/part-pile-2*.jsonl.zst",
    },
    "pad_to_max": False,
